...
def sqlalchemy_test_model_dao(sqlalchemy_test_model, sqlalchemy_test_sub_model_dao):
    ...
    class TestModelDao(SqlAlchemyDao):
        ...
        @staticmethod
        def from_domain(obj: sqlalchemy_test_model) -> "TestModelDao":
            dao = TestModelDao(
            ...
            dao.items = [
                sqlalchemy_test_sub_model_dao.from_domain(e) for e in obj.items  # type: ignore
            ]
            return dao
    ...
    class TestSubModelDao(SqlAlchemyDao):
        ...
        def from_domain(obj: sqlalchemy_test_sub_model):
            return TestSubModelDao(
                id=obj.id,  # type: ignore
                name=obj.name,  # type: ignore
                item_id=obj.item_id,  # type: ignore
            )
